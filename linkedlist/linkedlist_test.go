...
func TestGetMiddleNode(t *testing.T) {
	assert.Equal(t, float64(3), GetMiddleNode(NewNodeWithNext(1, NewNodeWithNext(2, NewNodeWithNext(3, NewNodeWithNext(4, NewNode(5)))))).Value)
	assert.Equal(t, float64(2), GetMiddleNode(NewNodeWithNext(1, NewNodeWithNext(2, NewNodeWithNext(3, NewNode(4))))).Value)
}
...
func TestRDelNode(t *testing.T) {
	...
	assert.Equal(t, float64(3), delNode.Value)
}
